...
start = [Button(action_body="Меню", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Меню', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
         Button(action_body="Вопросы и ответы", columns=3, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Вопросы и ответы', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
         Button(action_body="change-city", columns=3, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Изменить город', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
         Button(action_body="Корзина", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Корзина', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle")]
...
ask_kb = [Button(action_body="Как связаться?", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Как с вами связаться?', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
         Button(action_body="Какие условия доставки?", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Какие условия доставки?', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
         Button(action_body="Какие есть способы оплаты?", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Какие есть способы оплаты?', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
Button(action_body="Клубная карта", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply",
...
card = [Button(action_body="Почему стоит приобрести нашу клубную карту?", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Почему стоит приобрести нашу клубную карту?', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
        Button(action_body="КАК ОНА РАБОТАЕТ?", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply",
               text='Что такое клубная карта и как она работает?', text_size="regular", text_opacity=60, text_h_align="center",
               text_v_align="middle"),
        Button(action_body="КАКОВА МАКСИМАЛЬНАЯ СКИДКА, КОТОРУЮ ВЫ МОЖЕТЕ ПОЛУЧИТЬ С ПОМОЩЬЮ КАРТЫ", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply",
               ...
               text_v_align="middle"),
        Button(action_body="КАК МНЕ ПРИОБРЕСТИ КЛУБНУЮ КАРТУ", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply",
               text='Как мне приобрести клубную карту?', text_size="regular", text_opacity=60, text_h_align="center",
               text_v_align="middle"),
        Button(action_body="СМОГУ ЛИ Я ИСПОЛЬЗОВАТЬ КАРТУ", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Смогу ли я использовать карту, если забыл е дома, лишь назвав свое имя?', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
         Button(action_body="КАК УЗНАТЬ", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply", text='Как узнать, сколько баллов у меня уже есть?', text_size= "regular", text_opacity=60, text_h_align="center", text_v_align= "middle"),
          Button(action_body="otmena", columns=6, rows=1, bg_color="#ffffff", silent=True, action_type="reply",
                 text='Назад', text_size="regular", text_opacity=60, text_h_align="center",
                 text_v_align="middle")]
